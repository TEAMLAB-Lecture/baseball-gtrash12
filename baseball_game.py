...
def is_validated_number(user_input_number):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    result = is_digit(user_input_number) and is_between_100_and_999(user_input_number) and is_duplicated_number(user_input_number) == False
    # ==================================
    return result
...
def get_not_duplicated_three_digit_number():
    ...
    while is_validated_number(str(result)) == False :
        result = get_random_number()
    # ==================================
    return result
...
def get_strikes_or_ball(user_input_number, random_number):
    ...
    result = [0,0]
    for i in enumerate(random_number) :
        if i[1] in user_input_number:
            if i[1] == user_input_number[i[0]] :
                result[0] += 1
            else :
                result[1] += 1
    # ==================================
...
def is_yes(one_more_input):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    lower_str = one_more_input.lower()
    result = False
...
def is_no(one_more_input):
    ...
    lower_str = one_more_input.lower()
    result = False
    if lower_str == 'n' or lower_str == 'no' :
        result = True
    # ==================================
    return result
